...
#Region "Load dữ liệu cho các combobox"
    ...
    Public Sub loadGdvVatTuChaoGia()
        ...
        Else
            ...
            sql &= " LEFT OUTER JOIN BANGCHAOGIA ON BANGCHAOGIA.Sophieu=CHAOGIA.Sophieu"
            sql &= " LEFT OUTER JOIN TENVATTU ON VATTU.IDTenvattu=TENVATTU.ID"
            sql &= " LEFT OUTER JOIN TENHANGSANXUAT ON VATTU.IDHangSanxuat=TENHANGSANXUAT.ID"
            sql &= " LEFT OUTER JOIN TENDONVITINH ON VATTU.IDDonvitinh=TENDONVITINH.ID"
            sql &= " LEFT OUTER JOIN tblTienTe ON VATTU.Tiente1=tblTienTe.ID"
            ...
            sql &= " SELECT CHAOGIAAUX.ID AS IDCGAUX,Sophieu AS SoPhieu,Noidung AS NoiDung,HangSx AS HangSX, Donvi AS MaDVT,"
...
#End Region
    ...
    Private Sub gdvTaiLieuCT_RowCellClick(sender As System.Object, e As DevExpress.XtraGrid.Views.Grid.RowCellClickEventArgs)
        If e.Column.FieldName = "File" Then
            If e.CellValue Is Nothing Then Exit Sub
            If e.CellValue.ToString = "" Then Exit Sub
    ...
    Private Sub btDongPTinhGia_Click(sender As System.Object, e As System.EventArgs)
        pTinhGia.Visible = False
    End Sub

    Private Sub tbHSChiaGiaCU_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
        If e.Button.Index = 1 Then
            tbHSChiaGiaCU.EditValue = 0.85
        End If
    End Sub

    Private Sub tbHSNhanGiaBB_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
        If IsDBNull(gdvVTCT.GetFocusedRowCellValue("PTBB")) Then
            tbHSNhanGiaBB.EditValue = 0
            tbGiaBB.EditValue = 0
        Else
    ...
    Private Sub tbHSNhanGiaBL_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
        If IsDBNull(gdvVTCT.GetFocusedRowCellValue("PTBL")) Then
            tbHSNhanGiaBL.EditValue = 0
            tbGiaBL.EditValue = 0
        Else
    ...
    Private Sub tbHSChiaGiaNhap_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
        If e.Button.Index = 1 Then
            tbHSChiaGiaNhap.EditValue = 0.85
        End If
    End Sub

    Private Sub tbHSChiaGiaCU_EditValueChanged(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub tbHSNhanGiaBB_EditValueChanged(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub tbHSNhanGiaBL_EditValueChanged(sender As System.Object, e As System.EventArgs)
        If tbGiaList.EditValue = 0 Then
            tbGiaBL.EditValue = 0
        Else
            If Not _exit Then
    ...
    Private Sub tbHSChiaGiaNhap_EditValueChanged(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub tbGiaCU_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
    ...
    Private Sub tbGiaBB_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
    ...
    Private Sub tbGiaBL_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
    ...
    Private Sub tbLayGiaNhap_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
    ...
    Private Sub tbGiaCU_EditValueChanged(sender As System.Object, e As System.EventArgs)
        If tbGiaCungUng.EditValue <> 0 Then
            Dim _e As Boolean = _exit
            _exit = True
    ...
    Private Sub tbGiaBB_EditValueChanged(sender As System.Object, e As System.EventArgs)
        Dim _e As Boolean = _exit
        _exit = True
        If tbGiaList.EditValue = 0 Then
            tbHSNhanGiaBB.EditValue = 0
    ...
    Private Sub tbGiaBL_EditValueChanged(sender As System.Object, e As System.EventArgs)
        Dim _e As Boolean = _exit
        _exit = True
        If tbGiaList.EditValue = 0 Then
            tbHSNhanGiaBL.EditValue = 0
    ...
    Private Sub tbLayGiaNhap_EditValueChanged(sender As System.Object, e As System.EventArgs)
        If tbGiaNhap.EditValue <> 0 Then
            Dim _e As Boolean = _exit
            _exit = True
    ...
    Private Sub tbSoDong_ButtonClick(sender As System.Object, e As DevExpress.XtraEditors.Controls.ButtonPressedEventArgs)
