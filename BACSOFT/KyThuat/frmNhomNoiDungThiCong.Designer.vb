...
Partial Class frmNhomNoiDungThiCong
    ...
    Private Sub InitializeComponent()
        ...
        'GridColumn3
        '
        Me.GridColumn3.Caption = "Nhóm nội dung thi công"
