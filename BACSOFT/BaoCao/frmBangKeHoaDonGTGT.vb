...
Public Class frmBangKeHoaDonGTGT
    ...
    Private Sub frmBangKeHoaDonGTGT_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Select Case Me.Tag
            Case "BangKeHoaDonBanRa"
                workbook = Factory.GetWorkbook("\\bacboss\Data$\thue\bangkebanra.xls", System.Globalization.CultureInfo.CurrentCulture)
            Case "BangKeHoaDonMuaVao"
                workbook = Factory.GetWorkbook("\\bacboss\Data$\thue\bangkemuavao.xls", System.Globalization.CultureInfo.CurrentCulture)
        End Select
