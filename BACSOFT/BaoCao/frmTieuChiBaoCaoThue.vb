...
Public Class frmTieuChiBaoCaoThue



    Private Sub frmTieuChiBaoCaoThue_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub BaoCaoSoQuyTienMat()
        Try
            ...
            sql &= "SELECT "
            sql &= "("
            sql &= "    ISNULL((SELECT SUM(SoDuNo) FROM DUNOTAIKHOANDAUKY WHERE TaiKhoan Like @TaiKhoan + '%' AND Nam = @Nam),0) "
            sql &= "    + "
            ...
            Dim f As New frmIn("Báo cáo sổ quỹ tiền mặt")
            Dim rpt As New rptSoQuyTienMat
    ...
    Private Sub BaoCaoSoQuyTienGui()
        Try
