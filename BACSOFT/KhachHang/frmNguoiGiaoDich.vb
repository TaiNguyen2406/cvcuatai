...
Public Class frmNguoiGiaoDich

    Private Sub frmNguoiGiaoDich_Load(sender As Object, e As System.EventArgs) Handles Me.Load
    ...
    Public Sub loadDS()
        ...
        sql &= " FROM NHANSU "
        sql &= " LEFT OUTER JOIN KHACHHANG ON KHACHHANG.ID=NHANSU.Noictac"
        ...
        End If
        If MaTruyCap <> DSMaTruyCap.PTH_NV__MUA_HANG And MaTruyCap <> DSMaTruyCap.PTH_NV_MUA_BAN And MaTruyCap <> DSMaTruyCap.POR_NV_MUA_BAN And MaTruyCap <> DSMaTruyCap.POR_TRUONG_PHONG And MaTruyCap <> DSMaTruyCap.PTH_TRUONG_PHONG And MaTruyCap <> DSMaTruyCap.PQL_TRUONG_PHONG Then
