...
Public Class frmTHDiemThiKyNang

    Private Sub frmDiemThiKyNang2_Load(sender As Object, e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btXoa_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mXoa.ItemClick
