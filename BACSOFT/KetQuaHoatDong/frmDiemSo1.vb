...
Public Class frmDiemSo1

    Private Sub frmDiemSo_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        If Not KiemTraQuyenSuDungKhongCanhBao("Menu", Me.Parent.Tag, DanhMucQuyen.Admin) Then
            ...
            'btUpdateDiem1.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            btUpdateDiem2.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            btUpdateDiemVH.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
            '  btXem.Visibility = DevExpress.XtraBars.BarItemVisibility.Never
...
#End Region
    ...
    Private Sub gdvCT_RowStyle(sender As System.Object, e As DevExpress.XtraGrid.Views.Grid.RowStyleEventArgs) Handles gdvCT.RowStyle
        If gdvCT.GetRowCellValue(e.RowHandle, "IDNhanVien") = CType(TaiKhoan, Int32) Then
            If gdvCT.GetRowCellValue(e.RowHandle, "PhanTramMoi") < 50 Then
                e.Appearance.BackColor = Color.Red
            ElseIf gdvCT.GetRowCellValue(e.RowHandle, "PhanTramMoi") >= 50 And gdvCT.GetRowCellValue(e.RowHandle, "PhanTram") < 75 Then
    ...
    Private Sub gdvCT_RowCellStyle(sender As System.Object, e As DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs) Handles gdvCT.RowCellStyle
        ...
        If e.Column.FieldName = "PhanTram" Then
            ...
            Else
                e.Appearance.BackColor = Color.Chartreuse
            End If
        ElseIf e.Column.FieldName = "PhanTramMoi" Then
            If e.CellValue < 50 Then
                e.Appearance.BackColor = Color.Red
            ElseIf e.CellValue >= 50 And e.CellValue < 75 Then
                e.Appearance.BackColor = Color.Yellow
            Else
                e.Appearance.BackColor = Color.Chartreuse
            End If
    ...
    Private Sub btTyLeQuyDoi_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btTyLeQuyDoi.ItemClick
    ...
    Private Sub btUpdateDiem2_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btUpdateDiem2.ItemClick
        If Not KiemTraQuyenSuDung("Menu", Me.Parent.Tag, DanhMucQuyen.Admin) Then Exit Sub
        Try
            For i As Integer = 0 To gdvCT.RowCount - 1
                'PTDiemTamUng
                If Not IsDBNull(gdvCT.GetRowCellValue(i, "PTDiemTamUng")) Then
                    If gdvCT.GetRowCellValue(i, "PTDiemTamUng") > 0 Then
                        AddParameter("@Diem1", gdvCT.GetRowCellValue(i, "PhanTramMoi") * 40)
                    Else
                        AddParameter("@Diem1", gdvCT.GetRowCellValue(i, "DiemMoi"))
                    End If
                Else
                    AddParameter("@Diem1", gdvCT.GetRowCellValue(i, "DiemMoi"))
                End If
    ...
    Private Sub btXemCachMoi_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btXemCachMoi.ItemClick
        ...
        If IsDBNull(cbPhong.EditValue) Or cbPhong.EditValue Is Nothing Then
            ...
            Dim t(CType(rcbPhongBan.DataSource, DataTable).Rows.Count) As Boolean
            For j As Integer = 0 To t.Length - 1
                t(j) = False
            Next
            Dim dsKQ As New DataSet
            Dim tbPhong As DataTable = CType(rcbPhongBan.DataSource, DataTable)
            Dim _count = tbPhong.Rows.Count - 1
            Dim _i As Integer = 0
                ...
                Dim thread1 As New Thread(
                        Sub()
                            ...
                            Else
                                AddParameterWhere("@DaDuyet", 0)
                            End If
                            Select Case tbPhong.Rows(_i)("ID")
                                Case 1
                                    _prc = "prc_DiemSoPQL"
                                ...
                                Case 2, 6
                                    ...
                                    AddParameterWhere("@TieuChi", cbTieuChi.EditValue)
                                    AddParameterWhere("@TinhTheo", cbTinhTheo.EditValue)
                                    AddParameterWhere("@IDPhong", tbPhong.Rows(_i)("ID"))
                                Case 5
                                    _prc = "prc_DiemSoTH"
                                    AddParameterWhere("@TieuChi", cbTieuChi.EditValue)
                                    AddParameterWhere("@TinhTheo", cbTinhTheo.EditValue)
                                ...
                                Case Else
                                    ...
                                    AddParameterWhere("@IDPhong", tbPhong.Rows(_i)("ID"))
                            End Select
                            Dim tbl As DataTable = ExecutePrcDataTable(_prc)
            ...
            For k As Integer = 0 To dsKQ.Tables.Count - 1
                tb.Merge(dsKQ.Tables(k))
            Next
        ...
        If Not tb Is Nothing Then
            For i As Integer = 0 To tb.Rows.Count - 1
                ...
                Select Case tb.Rows(i)("MaThuong")
                    Case 307
                        ...
                        If rows.Length > 0 Then
                            If Not IsDBNull(tb.Rows(i)("IDTCMH")) Then
                                If tb.Rows(i)("LuongNV") = 0 Then
                                    tb.Rows(i)("DiemMoi") = 0
                                Else
                                    tb.Rows(i)("LoiNhuan") = rows(0)("LoiNhuan")
                                    tb.Rows(i)("DiemMoi") = ((rows(0)("LoiNhuan") * tb.Rows(i)("DiemThamChieuMH") / tb.Rows(i)("LoiNhuanGopMH")) + tb.Rows(i)("DiemVH") + tb.Rows(i)("DiemNL") + tb.Rows(i)("ThamNien")) * (tb.Rows(i)("LuongThamChieuMH") / tb.Rows(i)("LuongNV"))
                                    tb.Rows(i)("PhanTramMoi") = tb.Rows(i)("DiemMoi") * 100 / 4000
                                End If
                ...
                If tb.Rows(i)("IDDepatment") <> 2 And tb.Rows(i)("IDDepatment") <> 6 Then
                    Select Case tb.Rows(i)("MaThuong")
                        Case 204, 305, 307, 501, 502, 2002, 3001, 4001, 400, 6002, 604
                        Case Else
                            tb.Rows(i)("DiemMoi") = tb.Rows(i)("Tong")
                            tb.Rows(i)("PhanTramMoi") = tb.Rows(i)("PhanTram")
                    End Select
    ...
    Private Sub btXemChiTietTheoPhieuThu_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btXemChiTietTheoPhieuThu.ItemClick
        ...
        sql &= "        FROM  THU"
        sql &= "        WHERE month(NgayThangCT)=" & cbThang.EditValue & " AND Year(NgayThangCT)= " & tbNam.EditValue.ToString
        sql &= "        UNION ALL"
        sql &= "        SELECT     ngaythangCT, sophieu, IDKh, sotien, Mucdich, IDUser, PhieuTC0, PhieuTC1"
        sql &= "        FROM  THUNH"
        sql &= "        WHERE month(NgayThangCT)=" & cbThang.EditValue & " AND Year(NgayThangCT)= " & tbNam.EditValue.ToString
        ...
        sql &= " ORDER BY right(HDNhanVien.ChiTiet,9)"
    ...
    Private Sub btUpdateDiemVH_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btUpdateDiemVH.ItemClick
        If Not KiemTraQuyenSuDung("Menu", Me.Parent.Tag, DanhMucQuyen.Admin) Then Exit Sub
        Try
            For i As Integer = 0 To gdvCT.RowCount - 1
    ...
    Private Sub mTinhDiemTamUngKT_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mTinhDiemTamUngKT.ItemClick
        If ShowCauHoi("Tính điểm tạm ứng cho kỹ thuật") Then
            ...
            gdvCT.BeginUpdate()
            For i As Integer = 0 To gdvCT.RowCount - 1
                If gdvCT.GetRowCellValue(i, "PhanTramMoi") < HS Then
                    gdvCT.SetRowCellValue(i, "PTDiemTamUng", HS - gdvCT.GetRowCellValue(i, "PhanTramMoi"))
                End If
            Next
            gdvCT.EndUpdate()
        End If
    ...
    Private Sub btUpdateLNTamUng_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btUpdateLNTamUng.ItemClick
        If Not KiemTraQuyenSuDung("Menu", Me.Parent.Tag, DanhMucQuyen.Admin) Then Exit Sub
        Try
            For i As Integer = 0 To gdvCT.RowCount - 1
                    ...
                    Case 307
                        ...
                        If rows.Length > 0 Then
                            If Not IsDBNull(tb.Rows(i)("IDTCMH")) Then
                                ...
                                Else
                                    tb.Rows(i)("LoiNhuan") = rows(0)("LoiNhuan")
                                    tb.Rows(i)("DiemMoi") = ((rows(0)("LoiNhuan") * tb.Rows(i)("DiemThamChieu") / tb.Rows(i)("LoiNhuanGop")) + tb.Rows(i)("DiemVH") + tb.Rows(i)("DiemNL") + tb.Rows(i)("ThamNien")) * (tb.Rows(i)("LuongThamChieu") / tb.Rows(i)("LuongNV"))
                                    tb.Rows(i)("PhanTramMoi") = tb.Rows(i)("DiemMoi") * 100 / 4000
                                End If
