...
#End Region
        ...
        Try
            For i As Integer = 0 To gdvCT.RowCount - 1
                ...
                Else
                    AddParameter("@Diem1", gdvCT.GetRowCellValue(i, "DiemMoi"))
                End If
                If gdvCT.GetRowCellValue(i, "DaThu") Is Nothing Then
                    AddParameter("@DoanhThu1", 0)
                Else
    ...
    Private Sub btXemChiTietBCThuTien_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btXemChiTietBCThuTien.ItemClick
        ...
        Dim tb As DataTable = ExecuteSQLDataTable(sql)
        If Not tb Is Nothing Then
            Dim f As New frmChiTietBaoCaoThuTien1
            f.gdv.DataSource = tb
    ...
    Private Sub btCapNhatDMDiem_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles btCNDMDiemThuong.ItemClick
        If Not KiemTraQuyenSuDung("Menu", Me.Parent.Tag, DanhMucQuyen.Admin) Then Exit Sub
