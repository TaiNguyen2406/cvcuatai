...
Public Class frmUpdateGhiTangCCDC

    Public idChungTu As Object


    Private Sub frmUpdateGhiTangCCDC_Load(sender As Object, e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btGhiLai_Click(sender As System.Object, e As System.EventArgs) Handles btGhiLai.Click
        ...
        If gdvData.RowCount <= 0 Then
            ShowCanhBao("Chưa có nội dung công cụ dụng cụ!")
            Exit Sub
        End If
        ...
        Try
            ...
            If TrangThai.isAddNew Then
                ...
                Me.Text = "Cập nhật chứng từ ghi tăng CCDC"
                ShowAlert("Đã thêm mới chứng từ ghi tăng CCDC thành công")
            Else
                ShowAlert("Đã cập nhật chứng từ ghi tăng CCDC thành công")
            End If
    ...
    Private Sub btnThemMoi_Click(sender As System.Object, e As System.EventArgs) Handles btnThemMoi.Click
        ...
        Me.Text = "Thêm mới chứng từ ghi tăng CCDC"
    End Sub
