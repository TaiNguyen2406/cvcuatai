...
Public Class frmDsCongCuDungCu

    Private Sub frmDsCongCuDungCu_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        LoadDsNhomVT()
        LoadDsTenVT()
        LoadDsHangSX()
    ...
    Private Sub LocDsCongCuDungCu()
        ...
        Dim sql As String = "SELECT ID,TenHoaDon, "
        sql &= "(SELECT Ten FROM TENDONVITINH WHERE ID = VATTU.IDDonvitinh)DVT "
        sql &= "FROM VATTU WHERE isCongCuDungCu = 1 "
    ...
    Private Sub mnuThemMoi_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mnuThemMoi.ItemClick
        ...
        Dim f As New frmUpdateCongCuDungCu
