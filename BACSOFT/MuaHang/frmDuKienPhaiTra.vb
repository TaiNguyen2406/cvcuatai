...
Public Class frmDuKienPhaiTra
    Public _exit As Boolean = False
    Public _FileCGKinhDoanh As String = ""

    Private Sub frmDuKienPhaiTra_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
...
#End Region
    ...
    Private Sub gdvPhaiTraCT_RowCellStyle(sender As System.Object, e As DevExpress.XtraGrid.Views.Grid.RowCellStyleEventArgs) Handles gdvPhaiTraCT.RowCellStyle
        If e.Column.FieldName = "STT" Then
            ...
            If gdvPhaiTraCT.GetRowCellValue(e.RowHandle, "SoNgay") <= 0 Then
                e.Appearance.BackColor = Color.Red
            ElseIf gdvPhaiTraCT.GetRowCellValue(e.RowHandle, "SoNgay") > 0 And gdvPhaiTraCT.GetRowCellValue(e.RowHandle, "SoNgay") <= 3 Then
    ...
    Private Sub gdvPhaiTraCT_MouseDown(sender As System.Object, e As System.Windows.Forms.MouseEventArgs) Handles gdvPhaiTraCT.MouseDown
        ...
        If e.Button = System.Windows.Forms.MouseButtons.Right Then
            PopupMenu1.ShowPopup(gdvPhaiTra.PointToScreen(e.Location))
        End If
    End Sub

    Private Sub mXacNhanDaThanhToan_ItemClick(sender As System.Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles mXacNhanDaThanhToan.ItemClick
        If ShowCauHoi("Xác nhận đã thanh toán ?") Then
            Dim c As Integer = 0
